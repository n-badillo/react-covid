...
const About = () => {
  return (    
    <div id="about" className="container">
      ...
      <li>Implement Choropleth maps or other forms of data visualization</li>
      ...
      <div><h4>References</h4></div>
      <div>The API is located <a href='https://api.covid19api.com/total/country/united-states'>here.</a></div>
      </div>
  )
}
